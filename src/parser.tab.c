...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_BOOLCONST = 8,                  /* BOOLCONST  */
  YYSYMBOL_9_n_ = 9,                       /* '\n'  */
...
static const char *const yytname[] =
{
  ...
  "CHARCONST", "STRINGCONST", "OPERAND", "BOOLCONST", "'\\n'", "$accept",
  "input", "$@1", "$@2", "$@3", "$@4", "$@5", "$@6", YY_NULLPTR
};
...
{
       2,     6,     4,     8,    10,    12,    14,     3,     0,     2,
       2,     2,     2,     2,     2,     1,     7,     5,     9,    11,
      13,    15
};
